<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="report-notes.aspx.vb" Inherits="reportnotes" %>
...
<asp:ListItem Text="" Value="0" />
    ...
    <td class="label">PM</td><td><asp:DropDownList ID="DDL_PM" runat="server" DataSourceID="SDS_PMs" DataTextField="Initials" DataValueField="Initials" AppendDataBoundItems="true">
