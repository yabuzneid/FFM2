<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="reports.aspx.vb" Inherits="reports" %>
...
<h1>Reports</h1>
    ...
    <table>
        ...
        <tr><td>JUMP TO REPORT</td><td colspan=3><asp:Literal ID="LIT_JobNumberDropDown" runat="server" /></td></tr>
        <tr><td>JUMP TO PERIOD</td><td>
            <asp:TextBox ID="startdate" runat="server" CssClass="pickdate" Width="80px"></asp:TextBox>
         </td>
        <td colspan="2"><asp:TextBox ID="enddate" runat="server" CssClass="pickdate" Width="80px"></asp:TextBox></td></tr>
        <tr><td colspan="4">
