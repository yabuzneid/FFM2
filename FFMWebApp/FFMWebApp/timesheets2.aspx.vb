...
Partial Class timesheets2
    ...
    Sub page_load()
        ...
        Try
            ...
            If IsPostBack = False Then
                ...
                ' Response.Write("::" & Session("DateRangeStart") & "::")
        ...
        'timerFinish = Now()
        'TimerSpan = timerFinish.Subtract(timerStart)
        'TotalTimerSpan = TotalTimerSpan + TimerSpan
        'LIT_WorkerList.Text = LIT_WorkerList.Text & " TIMER: " & TotalTimerSpan.Seconds & "." & TotalTimerSpan.Milliseconds
    ...
    Sub MakeTypeDropDown()
        ...
        DDL_Type.SelectedValue = Session("SelectedOffice")
    ...
    Function GenerateEmployeeWeekTotals(ByVal StartDate As DateTime, ByVal EndDate As DateTime, ByVal PMLoggedIn As String) As String
        ...
        Try
            ...
            While drEmployees.Read
                ...
                WorkerID = SafeString(drEmployees.Item("EmployeeID"))
                Username = SafeString(drEmployees.Item("Username"))
                FirstName = SafeString(drEmployees.Item("FirstName"))
                LastName = SafeString(drEmployees.Item("LastName"))
                PayrollID = SafeString(drEmployees.Item("PayrollID"))
                ...
                strResult = strResult & "<tr " & HilightClass & "><td>" & PayrollID & "</td><td style=""width:120px""><a href=""worker.aspx?id=" & WorkerID & "&startdate=" & StartDate & "&enddate=" & EndDate & """>" & LastName & ", " & FirstName & "</a></td>"
