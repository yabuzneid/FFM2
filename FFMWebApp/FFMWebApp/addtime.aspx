<%@ Page Title="" Language="vb" AutoEventWireup="true" MasterPageFile="~/MasterPage.Master" CodeBehind="addtime.aspx.vb" Inherits="FFMWebApp.addtime" %>
    ...
    <table class="editform">
        ...
        <asp:Panel ID="Panel_Employees" runat="server" Visible="false">
            <tr>
                ...
                <td>
                     <asp:DropDownList ID="DDL_Employee" runat="server"   DataTextField="FullName" DataValueField="EmployeeID" AppendDataBoundItems="true">
        ...
        <asp:Panel ID="Panel_SingleDay" runat="server" Visible="true">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="TXT_EndDate" runat="server" CssClass="pickdate" Width="80px"></asp:TextBox>
        ...
        <asp:Panel ID="Panel_MultiDay" runat="server" Visible="false">
            <tr>
                ...
                <td class="notes">(Weekends will be skipped automatically.)</td>
            </tr>

            <tr>
                <td class="label">End Date</td>
                <td>
                    <asp:TextBox ID="TXT_EndDateMulti" runat="server" CssClass="pickdate" Width="80px"></asp:TextBox>
                </td>
                <td class="notes"></td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="DDL_StartTimeMulti" runat="server"  />
                    To
                    <asp:DropDownList ID="DDL_EndTimeMulti" runat="server"   />
                </td>
                <td></td>
            </tr>
        </asp:Panel>
        ...
        <tr>
            ...
            <td class="notes">(example: 01-03-001234)</td>
        </tr>

        <tr>
            <td class="label">Prevailing Wage</td>
            <td>
                <asp:DropDownList ID="DDL_PW" runat="server">
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="TXT_Project" runat="server"></asp:TextBox></td>
            <td class="notes"></td>
        </tr>


        <tr>
            <td class="label">Shift Type</td>
            <td>
...
-->
        <tr>
            ...
            <td>
                <asp:DropDownList ID="DDL_PerDiem" runat="server">
                    <asp:ListItem Text="" Value="" />
        ...
        <tr>
            <td class="label">Injured</td>
            <td>
                <asp:DropDownList ID="DDL_Injured" runat="server">
                    <asp:ListItem Text="" Value="" />
                    <asp:ListItem Text="Yes" Value="Yes" />
        ...
        <tr>
            ...
            <td colspan="2">
                <asp:TextBox ID="TXT_Comments" runat="server" TextMode="MultiLine" Width="250px" Height="50px"></asp:TextBox></td>
        </tr>
