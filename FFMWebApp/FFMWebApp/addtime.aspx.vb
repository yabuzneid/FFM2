...
Partial Class addtime
    ...
    Sub page_load()
        ...
        If IsPostBack = False Then
            DDL_Employee.DataSource = GetEmployeeList()
            DDL_Employee.DataBind()
            DDL_StartTime.DataSource = PickTime()
            DDL_StartTime.DataBind()
            DDL_EndTime.DataSource = PickTime()
            DDL_EndTime.DataBind()
            DDL_StartTimeMulti.DataSource = PickTime()
            DDL_StartTimeMulti.DataBind()
            DDL_EndTimeMulti.DataSource = PickTime()
            DDL_EndTimeMulti.DataBind()
            DDL_State.DataSource = GetStates()
            DDL_State.DataBind()
    ...
    Sub PopulateFromCookies()
        ...
        Try
            ...
            If Not Request.Cookies("enter_pm") Is Nothing Then
                If CheckIfPMExists(Request.Cookies("enter_pm").Value) = True Then
                    DDL_PM.SelectedValue = Request.Cookies("enter_pm").Value
                End If
            End If
