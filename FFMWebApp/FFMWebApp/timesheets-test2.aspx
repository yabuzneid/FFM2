<%@ Page Title="" Language="vb" AutoEventWireup="true" MasterPageFile="~/MasterPage.Master" CodeBehind="timesheets-test2.aspx.vb" Inherits="FFMWebApp.timesheets_test2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="CPH_MainContent" runat="Server">
    ...
    <div id="synccontrol">
        <asp:Literal ID="LIT_SyncData" runat="server"></asp:Literal></div>
    ...
    <table style="margin: 0 auto;">
        <tr>
            ...
            <td style="width: 30%; vertical-align: top;">
                <asp:Literal ID="LIT_ProjectList" runat="server"></asp:Literal></td>
        </tr>
    </table>
