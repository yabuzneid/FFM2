<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="report-timebyjob2.aspx.vb" Inherits="reporttimebyjob2" %>
...
<tr>
    ...
    <td><asp:TextBox ID="TXT_StartDate" runat="server" CssClass="pickdate"></asp:TextBox></td>

    <td class="label">End</td>
    <td><asp:TextBox ID="TXT_EndDate" runat="server" CssClass="pickdate"></asp:TextBox></td>
</tr>
<tr>
    <td class="label">Job #</td>
    <td><asp:TextBox ID="TXT_JobNumber" runat="server"></asp:TextBox></td>

    <td class="label" colspan="2"><asp:CheckBox ID="CHK_AVOnly" runat="server" Width="55px" />AV Employees Only</td>
