<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="OpenShifts.aspx.vb" Inherits="OpenShifts" %>
...
<p class="info">These are the employee events that are older than 24 hours but have not been converted into shifts yet, usually meaning that those shifts seen here to be started were not closed yet. 
...
For events that you know are valid (ex: employee stops working for Comnet, never punches out of last shift), please use the "Ignore" button to supress the warning on this page.</p>
